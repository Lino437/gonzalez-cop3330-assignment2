...
class PaymentCalculatorTest {
    ...
    public void  valuesBalance5000Apr12MonthPay100(){
        Assert.assertEquals(70 ,PaymentCalculator.calculateMonthsUntilPaidOff(5000, 12, 100));
    }

    @Test
    @DisplayName("Should pass for 0 apr the given values")
    public void  valuesBalance5000Apr0MonthPay100(){
        Assert.assertEquals(0 ,PaymentCalculator.calculateMonthsUntilPaidOff(5000, 0, 100));
    }
